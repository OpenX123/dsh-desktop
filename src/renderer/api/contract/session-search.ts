/**
 * Vendored content-search bounds from the official apiproxy session-search
 * module (constants plus the code-point-safe truncation helper).
 * @module desktop/renderer/api/contract/session-search
 */
