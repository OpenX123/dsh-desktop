...
官方 Web UI 自身的能力（技能、插件、交互等）不需要等本项目的排期，会随官方发版直接出现在窗口里。桌面外壳自身的后续工作见[开发指南](docs/development.zh.md#当前状态)与 [TODO](TODO.md)：macOS/Windows 签名与公证、系统通知、OS Keychain、语音输入，以及内置运行时的独立更新通道、运行中实例的周期探测提示等。
